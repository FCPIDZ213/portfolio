          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
             ...
             {/* <Nav.Link href="https://blog.nodex.codes" target="_blank" className={activeLink === 'blog' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('blog')}>Blog</Nav.Link> */}
              ...
              <Nav.Link href="https://explorer.dz-staking.com/" target="_blank" className={activeLink === 'stake' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('stake')}>Explorer</Nav.Link>              
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://discordapp.com/users/866745255678967809" target="_blank"><img src={navIcon3} alt="Discord" /></a>
                <a href="https://github.com/FCPIDZ213"target="_blank"><img src={navIcon2} alt="Github" /></a>
                <a href="https://twitter.com/DZstaking" target="_blank"><img src={navIcon1} alt="Twitter" /></a>
